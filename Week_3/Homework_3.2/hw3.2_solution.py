...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        # Using an empty itable for a placeholder so blog compiles before you make your changes

        cursor = self.posts.find(query).sort([('date', pymongo.DESCENDING)]).limit(num_posts)
